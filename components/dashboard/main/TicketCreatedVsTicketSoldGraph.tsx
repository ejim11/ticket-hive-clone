...
const TicketCreatedVsTicketSoldGraph = ({ month }: { month: string }) => {
    const isMobile = useMediaQuery({
        query: "(max-width: 650px)",
    });

    const { filteredEvents, ticketPerMonth, ticketSoldPerMonth } =
        getDashboardInfoStats(month, eventsDashboardData);
    ...
    return (
        <div className="border border-[rgba(239,240,243,1)] rounded-[0.8rem] h-[52rem] smd:h-auto mt-[3rem] p-[2rem] font-outfit flex flex-col justify-between">
