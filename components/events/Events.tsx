...
const Events = () => {
    ...
    return (
        <section className="font-outfit">
            <div className="flex justify-between px-[5rem] h-[9.4rem] bg-[#F8F8F8] items-center  border-b border-t border-[rgba(224,225,230,1)]">
                <p className="text-[rgba(41,41,41,0.8)] text-[3.2rem] font-semibold">
                    BROWSE EVENTS
                </p>
                <div className="flex items-center text-[rgba(34,34,34,0.6)] text-[1.8rem]">
                    <button
                    ...
                    >
                        <p>Sort By</p>
                        <MdKeyboardArrowDown
                            className={`w-[2.4rem] h-[2.4rem] ml-[1rem] text-color-current transition-all duration-150 ease-in ${
                                displaySortbyModal
                                    ? "rotate-[180deg]"
                                    : " rotate-0"
                            } `}
                        ...
                        <AnimatePresence>
                            {displaySortbyModal && (
                                <motion.div
                                    ...
                                    exit={{ opacity: 0, y: -40 }}
                                    className="absolute p-[2.4rem] top-[6rem] right-0 flex flex-col w-auto bg-color-grey-2 border-l border-r border-b border-[rgba(224,225,230,1)] shadow-sort-event"
                                >
            ...
            <div className="grid gap-[3.5rem] grid-cols-3 px-[5rem] py-[8rem]">
