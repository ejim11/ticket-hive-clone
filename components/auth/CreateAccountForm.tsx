...
const CreateAccountForm = () => {
  ...
  return (
    <div className="font-outfit px-[5rem] 4xl:px-[3rem] 2xl:px-[1rem] sm:px-0 flex flex-cols items-center flex-col my-[2rem]">
      <h3 className="text-[4rem] font-medium sm:text-[3rem]">Create Account</h3>
