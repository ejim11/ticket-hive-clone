...
const HomeComp = () => {
  return (
    <main className="font-outfit">
      <SectionCover className="h-[calc(100vh-9rem)] bg-home-1 bg-no-repeat bg-center py-[5rem] bg-cover     flex">
        <div className="w-[50%] flex flex-col justify-end">
          ...
          <p className="text-[rgba(255,255,255,0.75)] text-[2rem] mt-[2.4rem] mb-[4rem]">
            Convenient and stress-free solutions for both attendees and
            organizers, designed to make your event planning seamless and
            enjoyable.
          </p>
          <div>
            <button
