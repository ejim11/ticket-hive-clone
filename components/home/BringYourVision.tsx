...
const BringYourVision = () => {
  return (
    <section className="bg-bring-vision bg-center bg-no-repeat bg-cover px-[3rem] sm:px-[2rem] h-[89rem] py-[10rem] attachment-bg flex flex-col justify-end items-center">
