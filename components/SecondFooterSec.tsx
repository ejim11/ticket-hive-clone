...
const SecondFooterSec = () => {
    return (
        <div className="p-[10rem] flex justify-between">
            <div className="w-[50%]">
                <Link href={"/"}>
                    <Image
                        src={logo2}
                ...
                <p className="text-[rgba(255,255,255,0.6)] mt-[1.5rem]">
            ...
            <div className="flex ">
                {footerLinks.map((item: any) => (
                    <div
                        key={item.title}
                        className="flex flex-col mr-[4rem] last:mr-0 text-[1.8rem] uppercase"
                    >
